<head>
    ...
    <link rel="stylesheet" href="<?= base_url()?>asset/adminlte/assets/vendor/libs/apex-charts/apex-charts.css" />
    <link rel="stylesheet" href="<?= base_url()?>asset/adminlte/assets/vendor/css/pages/page-misc.css" />

    <!-- Page CSS -->
    <link href="<?= base_url()?>asset/DataTables/datatables.min.css" rel="stylesheet"/>
    <!-- <link href="<?= base_url()?>asset/DataTables/DataTables-1.13.4/css/jquery.dataTables.min.css" rel="stylesheet"/>
    <link href="<?= base_url()?>asset/DataTables/Buttons-2.3.6/css/buttons.dataTables.min.css" rel="stylesheet"/> -->
